# Placeholder — motorcycle data stripped

RoadRacer shipped motorcycle road-race content here.

KartRacer source already exists on disk:
- Track GPX: `C:\\KartRacer\\data\\gpx` (129 one-lap files) — import via docs/CURSOR_BUILD_JOBS.md J1.1
- Coach pack skeletons: `C:\\KartRacer\\gpt-knowledge` — populate before upload
- Equivalents: `docs/KR_DATA_EQUIVALENTS.md`
