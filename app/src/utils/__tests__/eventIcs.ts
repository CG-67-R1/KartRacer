...

{
  const ics = buildEventIcs(
    {
      title: 'AKC: Round 1, Coffs Harbour',
      startDate: '2026-02-20',
      endDate: '2026-02-22',
      location: 'Phillip Island, Australia',
      description: 'Added from KartRacer\nhttps://example.com',
  ...
  assert('escapes comma in summary', ics.includes('SUMMARY:AKC: Round 1\\, Coffs Harbour'));
  assert('escapes newline in description', ics.includes('DESCRIPTION:Added from KartRacer\\nhttps://example.com'));
...

{
  ...
  assert('filename slug', eventIcsFilename('AKC: Round 1') === 'AKC-Round-1.ics');
}
