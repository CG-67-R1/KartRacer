...
KartRacerr first Play upload is a **new app**: after 31 Aug 2026 it **must** target API 36. SDK 57 already does if Gradle is unmodified.
...
- Physical device API: `http://localhost:3001`. Emulator-only `10.0.2.2` is **not** the Play binary.
