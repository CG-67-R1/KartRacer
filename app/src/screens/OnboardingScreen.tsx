      ...
      >
        ...
        {step === 0 && (
          <View style={styles.step}>
            <Text style={styles.title}>Welcome to KartRacer</Text>
            <Text style={styles.subtitle}>
              Before we get you to the good stuff — driver coach, kart setup, and track prep — we need to know who you are. (Don’t worry, it’s quick.)
            </Text>
        ...
        {step === 1 && (
          <View style={styles.step}>
            ...
            <Text style={styles.subtitle}>Chassis, class, or “the one I’ll own one day” — we’re not judging.</Text>
            <TextInput
              style={styles.input}
              placeholder="e.g. Tony Kart / Rotax Max, Birel ART / X30..."
        ...
        {step === 3 && (
          <View style={styles.step}>
            ...
            <Text style={[styles.prompt, { marginTop: 24 }]}>
              Let’s personalise KartRacer for you.
            </Text>
          </View>
        )}
        ...
        {step === 7 && (
          <View style={styles.step}>
            ...
            <Text style={styles.summaryClosing}>
              Whether you race, practice, or just love karts — KartRacer is here for coach, kart setup, and Q&A when you don’t have people to ask. Time to send it. 🏁
            </Text>
            <View style={[styles.justSendItBox, { marginTop: 16 }]}>
              <Text style={styles.justSendItTitle}>Coach matches how you ride</Text>
              <Text style={styles.justSendItText}>
                KartRacer AI uses your answers so Coach and Kart Setup stay at the right level of
                detail. You can change how you ride anytime in Settings.
              </Text>
            </View>
            <View style={styles.legalBlock}>
              <Text style={styles.legalIntro}>
                Before you continue, please review how KartRacer handles your data.
              </Text>
